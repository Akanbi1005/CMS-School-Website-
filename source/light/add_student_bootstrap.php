...
if (isset($_POST['submit'])) {
    ...
    $rollno = "P/ND/14/3210".$_POST['rollno'];
    $email = $_POST['email'];
    $reg = $_POST['reg'].$_POST['reg1'];;
    ...
    $insert = $con->insert_student('student', $firstname, $lastname, $rollno, $email, $reg, $department, $gender, $number, $parentname, $parentnumber, $birthdate, $address);
}
?>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="add_student_bootstrap.php" method="post"  id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="firstname" placeholder="enter first name" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="lastname" placeholder="enter last name" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="rollno" placeholder="enter roll no" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control input-height" size="16" placeholder="Registration Date" name="reg" type="text" value="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="parentname"  placeholder="enter parents name" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="parentnumber" type="text" placeholder="parents mobile number" class="form-control input-height" /> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control input-height" size="16" name="birth" placeholder="date of Birth" type="text" value="">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    <button type="submit" name="submit" class="btn btn-info m-r-20">Submit</button>
                                                    <button type="button" name="" class="btn btn-default">Cancel</button>
                                                </div>
                                            	</div>
                                       		 </div>
										</div>
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/add_student_bootstrap.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:14 GMT -->
</html>