                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="coursename" placeholder="enter course name" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="ccode" placeholder="enter course code" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/add_course_bootstrap.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:16 GMT -->
</html>