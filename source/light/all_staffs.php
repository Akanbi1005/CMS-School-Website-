					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_staff_material.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
					                                        ...
					                                        <tbody>
																<tr class="odd gradeX">
																	...
																	<td>
																		<a href="edit_staff.php" class="btn btn-primary btn-xs">
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/all_staffs.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:22 GMT -->
</html>