...
if (isset($_POST['submit'])) {
    ...
    $insert = $con->insert_prof('professor', $firstname, $lastname, $email, $join, $password, $designation, $department, $gender, $number, $birthdate, $address, $education);
}
?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="add_professor_bootstrap.php"  method="post">
                                        <div class="form-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group date form_date " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"data-link-format="yyyy-mm-dd">
                                                        <input class="form-control input-height" size="16" placeholder="Joining Date"  type="text" >
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                    </div>
                                                    <input type="hidden" id="dtp_input2" name="join"  />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <input type="hidden" id="dtp_input5" name="birth" value="" />
                                                </div>
                                            </div>
                                        	 <div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<textarea name="education" class="form-control-textarea" placeholder="Education" rows="5"></textarea>
												</div>
											</div>
											<div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    <button type="submit" value="submit" name="submit" class="btn btn-info m-r-20">Submit</button>
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/add_professor_bootstrap.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:08 GMT -->
</html>