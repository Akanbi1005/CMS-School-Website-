                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
	                                        <div class="form-group row">
	                                             ...
	                                             <div class="col-md-5">
	                                                 <input type="text" name="dpname" placeholder="enter department name" class="form-control input-height" /> </div>
	                                         </div>
											<div class="form-group row">
	                                             <label class="control-label col-md-3">Head Of Department
	                                             </label>
	                                             <div class="col-md-5">
	                                                 <input type="text" name="auther" placeholder="enter HOD name" class="form-control input-height" /> </div>
	                                         </div>
	                                         <div class="form-group row">
                                                <label class="control-label col-md-3">Department Start Date
	                                                ...
	                                                <div class="col-md-5">
			                                            <div class="input-group date form_date " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			                                                <input class="form-control input-height" size="16" placeholder="department start date" type="text" value="">
                                            ...
                                            <div class="form-group row">
	                                             ...
	                                             <div class="col-md-5">
	                                                 <input type="text" name="price" placeholder="enter title" class="form-control input-height" /> </div>
	                                         </div>	
	                                         <div class="form-group row">
                                                <label class="control-label col-md-3">Department Details
                                                </label>
                                                <div class="col-md-5">
                                                    <textarea name="details" placeholder="department details" class="form-control-textarea" rows="5" ></textarea>
                                                </div>
                                            </div>
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/add_department_bootstrap.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:20 GMT -->
</html>