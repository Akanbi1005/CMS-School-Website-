...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/book_appointment_material.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:35:04 GMT -->
<head>
...
<!-- Favicon -->
<link rel="shortcut icon" href="images/redixtouch.php" type="image/x-icon">
<link rel="icon" href="images/redixtouch.php" type="image/x-icon">

<!-- FontsOnline -->
<link href='https://fonts.googleapis.com/css?family=Roboto:400,500,700,900,300,100' rel='stylesheet' type='text/css'>

<!-- StyleSheets -->
<link rel="stylesheet" href="css/ionicons.min.php">
<link rel="stylesheet" href="css/materialize.min.php">
<link rel="stylesheet" href="css/bootstrap/bootstrap.min.php">
<link rel="stylesheet" href="css/font-awesome.min.php">
<link rel="stylesheet" href="css/main.php">
<link rel="stylesheet" href="css/style.php">
<link rel="stylesheet" href="css/responsive.php">

<!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
<link rel="stylesheet" type="text/css" href="rs-plugin/css/settings.php" media="screen" />

<!-- JavaScripts -->
<script src="js/vendors/modernizr.php"></script>
...
<div id="loader">
  <div class="loader">
    <div class="position-center-center"> <img src="images/logo.php" alt="" >
      <div class="progress">
...
<div id="wrap"> 
  ...
  <header class="header coporate-header">
    <div class="sticky">
      <div class="container">
        <div class="logo" style="margin-top:-10px;"> <a href="index-2.php"><img src="images/logo.php" alt=""></a> </div>
          ...
          <ul id="ownmenu" class="ownmenu">
            ...
            <li><a href="services.php">SERVICES</a> 
            	<ul class="dropdown">
            		...
            		<li><a href="html-development.php">html 5 Development </a> </li>
      ...
      <div class="tp-banner-fix ">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/1.php"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            
          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/2.php"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 

          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/3.php"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            
          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/4.php"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            
          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/5.php"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
    ...
    <section class="welcome padding-top-100 padding-bottom-100 ">
      <div class="container"> 
        ...
        <div class="row">
          ...
          <div class="col-md-5"> <img class="img-responsive" src="images/intro-tabs.php" alt="" > </div>
        </div>
      </div>
    </section>
        ...
        <div class="time-line"> 
          ...
          <ul class="row second">
            <li class="col-sm-6 pull-left text-right padding-right-100">
              ...
              <p>Our aims to develop and deliver an optimized website experience on devices with different widths and different resolutions: PC, notebook, tablet, Yaba Staff School phone, etc.</p>
            </li>
          </ul>
          <div class="clearfix"></div>
    ...
    <section class="portfolio port-wrap pink-bg padding-top-80">
      ...
      <div class="items row col-4"> 
        ...
        <article class="portfolio-item pf-web-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-1.php"> <a href="images/portfolio/img-1.php" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
               <h3><a href="pf-d-jo.php">Chemical Research Test Laboratory Management System</a></h3>
                <span><a href="pf-d-jo.php">Java Development</a></span> </div>
            </div>
          </div>
        </article>
        ...
        <article class="portfolio-item pf-branding-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-2.php"> <a href="images/portfolio/img-2.php" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="pf-w-admin-panel.php">Admin Panel</a></h3>
                <span><a href="pf-w-admin-panel.php">Wed Design</a></span> </div>
            </div>
          </div>
        </article>
        ...
        <!-- ITEM -->
        <article class="portfolio-item pf-web-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-3.php"> <a href="images/portfolio/img-3.php" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="pf-d-ecco.php">E-commerce &amp; Survey</a></h3>
                <span><a href="pf-d-ecco.php">Java Development</a></span> </div>
            </div>
          </div>
        </article>
        ...
        <!-- ITEM -->
        <article class="portfolio-item pf-branding-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-4.php"> <a href="images/portfolio/img-4.php" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="portfolio-single.php">Boulangerie product design</a></h3>
                <span><a href="portfolio-single.php">Branding &amp; Wed Design</a></span> </div>
            </div>
          </div>
        </article>
    ...
    <section class="why-choose padding-top-100 padding-bottom-100">
      <div class="container"> 
        ...
        <div class="row">
          ...
          <div class="col-md-5 text-bold"> <img class="img-responsive" src="images/why-choose-img.php" alt="" > </div>
        </div>
      </div>
    </section>
    ...
    <section class="list-style-featured light-gray-bg padding-top-80 padding-bottom-10 ">
      <div class="container"> 
        ...
        <div class="row margin-top-40"> 
    		<a href="contact-2.php" class="waves-effect waves-light btn btn-white ">Contact Us</a>
        </div>
        </div>
      </div>
    </section>
...
<!-- JavaScripts --> 
<script src="js/vendors/jquery/jquery.min.php"></script> 
<script src="js/vendors/wow.min.php"></script> 
<script src="js/vendors/bootstrap.min.php"></script> 
<script src="js/vendors/materialize.min.php"></script> 
<script src="js/vendors/own-menu.php"></script> 
<script src="js/vendors/jquery.prettyPhoto.php"></script> 
<script src="js/vendors/flexslider/jquery.flexslider-min.php"></script> 
<script src="js/vendors/jquery.isotope.min.php"></script> 
<script src="js/vendors/owl.carousel.min.php"></script> 
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/book_appointment_material.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:35:56 GMT -->
</html>