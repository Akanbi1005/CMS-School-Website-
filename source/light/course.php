                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                  ...
                                  <form action="course.inc.php" method="POST">
                                    <div class="card-body row">
                                        <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                             <input class = "mdl-textfield__input" type = "text" id = "txtCourseName" value="<?= $name?>">
                                             <label class = "mdl-textfield__label">Student Name</label>
                                          </div>
                                        </div>
                                        <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                             <input class = "mdl-textfield__input" type = "text" id = "txtCourseCode" name="roll" value="<?= $admin?>">
                                             <label class = "mdl-textfield__label" >Student Roll No</label>
                                          </div>
                                        </div>
                                        <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                             <input class = "mdl-textfield__input" type = "text" name="name" id = "txtCourseName">
                                        ...
                                        <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                             <input class = "mdl-textfield__input" type = "text" name="code" id = "txtCourseCode">
                                       ...
                                       <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                             <input class = "mdl-textfield__input" type = "text" name="unit" id = "txtCourseName">
                                             <label class = "mdl-textfield__label">Course Unit</label>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                              ...
                                              <option value="Computer Science">Computer Science</option>
                                               ...
                                               <option value="Computer Engineering">Computer Engineering</option>
                                                <option value="Quatity Suvery">Quatity Suvery</option>
                                                <option value="Electrical Engineering">Electrical Engineering</option>
                                                <option value="Hospitality">Hospitality</option>
                                                 <option value="IME">IME</option>
                                                 <option value="Mass Communication">Mass Communication</option>
                                                 <option value="Building & Constration">Building & Constration</option>
                                                </select>
                                          </div>
                                        </div>
                                         ...
                                         <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                             <input class = "mdl-textfield__input" type = "text" name="ca" id = "txtCourseName">
                                             <label class = "mdl-textfield__label">CA Score</label>
                                          </div>
                                        </div>
                                         <div class="col-lg-6 p-t-20"> 
                                          <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                             <input class = "mdl-textfield__input" type = "text" name="exam" id = "txtCourseName">
                                             <label class = "mdl-textfield__label">Exam Score</label>
                                          </div>
                                        </div>
                                      <?php
                                       # Make these a drop down 
                                      ?>
                                      ...
                                      <!--   <div class="col-lg-12 p-t-20"> 
                                         ...
                                         <div class="col-lg-12 p-t-20 text-center"> 
                                            <button type="submit" name="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Submit</button>
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/add_course.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:16 GMT -->
</html>