                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Student Scores View</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Student Scores View</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
											...
											<div class="white-box">
					                            ...
					                            <div class="p-rl-20">
						                            <ul class="nav customtab nav-tabs" role="tablist">
						                                <li class="nav-item"><a href="#tab1" class="nav-link active"  data-toggle="tab" >View Scores</a></li>
						                                <div class="p-rl-20">
					                            ...
					                            <div class="tab-content">
					                                <div class="tab-pane active fontawesome-demo" id="tab1">
                                                   	...
                                                   	<hr>
                                                   	<div class="col-md-3 col-6"> <strong>Total Unit:</strong>
			                                             <span class="text-muted"><?php echo $units['unit_sum'];?></span>
			                                        </div>
			                                        <div class="col-md-3 col-6"> <strong>Total Course Offered:</strong>
			                                            <span class="text-muted"><?php echo $select['course_sum'];?></span>
			                                        </div>
			                                        <div class="col-md-3 col-6"> <strong>Total Grade Point:</strong>
			                                            <span class="text-muted"><!-- <?=$cumulative_total / $units['unit_sum']?> --></span>
			                                        </div>
					                            </div>
					                        </div>
                                         </div>
