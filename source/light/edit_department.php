									...
									<div class="card-body row">
							            <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="Fashion Designing" id = "txtDepName">
						                     <label class = "mdl-textfield__label">Department Name</label>
						                  </div>
							            </div>
							            <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="Sanjay Shah" id = "txtDepHead">
						                     <label class = "mdl-textfield__label">Head Of Department</label>
						                  </div>
							            </div>
							            <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="2016-02-12" id = "date">
						                     <label class = "mdl-textfield__label" >Department Start Date</label>
						                  </div>
							            </div>
							            <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="150" id = "txtstdcapacity">
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/edit_department.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:21 GMT -->
</html>