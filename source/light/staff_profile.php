                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            <div class="profile-userpic">
                                                <img src="../assets/img/prof/prof4.jpg" class="img-responsive" alt=""> </div>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="profile-desc">
                                            Hello I am Celena Anderson a Clerk in Xyz College Surat. I love to work with all my college staff and seniour professors.
                                        </div>
                                        <ul class="list-group list-group-unbordered">
                                            <li class="list-group-item">
                                                <b>Gender </b>
					                            ...
					                            <div class="tab-content">
					                                <div class="tab-pane active fontawesome-demo" id="tab1">
															<div id="biography" >
							                                    ...
							                                    <hr>
							                                    <p class="m-t-30">Completed my graduation in Commerce from the well known and renowned institution of India – SARDAR PATEL COMMERCE COLLEGE, BARODA in 2000-01, which was affiliated to M.S. University. I ranker in University exams from the same university from 1996-01.</p>
							                                    <p>Worked as  Clerk and Head of the department at Sarda Collage, Rajkot, Gujarat from 2003-2015 </p>
							                                    ...
							                                    <hr>
							                                    <ul>
							                                        <li>One year experience as Jr. Clerk from April-2009 to march-2010 at B. J. Commerce College, Ahmedabad.</li>
							                                        <li>Three year experience as Jr. Clerk at V.S. Arts & Commerse Collage from April - 2008 to April - 2011.</li>
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/staff_profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:23 GMT -->
</html>