									...
									<div class="card-body row">
							            <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="Web Designing" id = "txtCourseName">
						                     <label class = "mdl-textfield__label">Course Name</label>
						                  </div>
							            </div>
							            <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="WE987" id = "txtCourseCode">
							            ...
							            <div class="col-lg-12 p-t-20"> 
								         ...
								         <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="2017-06-23" id = "date">
						                     <label class = "mdl-textfield__label" >Start From</label>
						                  </div>
							            </div>
							            <div class="col-lg-6 p-t-20"> 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" value="6 Months" id = "txtTimeLength">
							            ...
							            <div class="col-lg-6 p-t-20"> 
							             ...
							             <div class="col-lg-6 p-t-20"> 
							              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
									            <input class="mdl-textfield__input" type="text" id="list2" value="Pr. Mayank Trivedi" readonly tabIndex="-1">
...
<!-- Mirrored from radixtouch.in/templates/admin/Yaba Staff School/source/light/edit_course.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Oct 2018 17:30:17 GMT -->
</html>